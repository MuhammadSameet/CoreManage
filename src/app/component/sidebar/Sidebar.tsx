...
// // --- WIDTH ADJUSTMENT ---
// const drawerWidth = 280; // Isay 240 se badha kar 280 kar diya hai
// const closedDrawerWidth = 80; // Closed state ko bhi thoda manage kiya hai
...
// // ... (Baqi openedMixin aur closedMixin same rahega)
...
// // DrawerHeader aur Sidebar component ka baqi logic bilkul waisa hi hai jaisa aapne diya tha.
...
//                     <ListItemButton sx={getListItemStyle(pathname === '/users', true)}>
//                       <ListItemIcon sx={getIconStyle(pathname === '/users')}><ProfileIcon fontSize="small" /></ListItemIcon>
//                       <ListItemText primary="Collection Wise" sx={{ opacity: open ? 1 : 0 }} />
//                     </ListItemButton>
//                   </Link>
//                   <Link href="/users" style={{ textDecoration: 'none' }}>
//                     <ListItemButton sx={getListItemStyle(pathname === '/users', true)}>
//                       <ListItemIcon sx={getIconStyle(pathname === '/users')}><ProfileIcon fontSize="small" /></ListItemIcon>
//                       <ListItemText primary="User Report" sx={{ opacity: open ? 1 : 0 }} />
//                     </ListItemButton>
//                   </Link>
//                   <Link href="/users" style={{ textDecoration: 'none' }}>
//                     <ListItemButton sx={getListItemStyle(pathname === '/users', true)}>
//                       <ListItemIcon sx={getIconStyle(pathname === '/users')}><ProfileIcon fontSize="small" /></ListItemIcon>
//                       <ListItemText primary="Users Entry" sx={{ opacity: open ? 1 : 0 }} />
//                     </ListItemButton>
//                   </Link>
...
//                   <PeopleIcon />
//                 </ListItemIcon>
//                 <ListItemText primary="Manage Employee" sx={{ opacity: open ? 1 : 0 }} />
//                 {open && (openUserMenu ? <ExpandLess /> : <ExpandMore />)}
//               </ListItemButton>
//               <Collapse in={openUserMenu && open} timeout="auto" unmountOnExit>
//                 <List component="div" disablePadding>
